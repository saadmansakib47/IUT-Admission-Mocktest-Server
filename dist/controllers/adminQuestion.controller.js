...
export const deleteQuestionBankController = async (req, res) => {
    try {
        const { id } = req.params;
...
export const updateQuestionBankController = async (req, res) => {
    try {
        const { id } = req.params;
...
export const downloadQuestionBankCSV = async (req, res) => {
    try {
        const { id } = req.params;
        const bank = await QuestionBank.findById(id);
        if (!bank) {
